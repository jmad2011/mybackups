...
musicplr = terminal .. " -g 130x34-320+16 -e moc "
...
tags = {
       names = { "Main", "Geany", "Terms", "Chat", "Misc"},
...
vicious.register(netwidget, vicious.widgets.net, '<span background="#313131" font="Terminus 13" rise="2000"> <span font="Terminus 9" color="#7AC82E">${enp0s7 down_kb}</span> <span font="Terminus 7" color="#EEDDDD"></span> <span font="Terminus 9" color="#46A8C3">${enp0s7 up_kb} </span></span>', 3)
...
awful.util.spawn_with_shell("rxvt -e tmux new-session -d -n rtorrent -s autos rtorrent ")
awful.util.spawn_with_shell("rxvt -e tmux new-session -d -n rtorrent -s autos mediatomb ")
-- }}}
